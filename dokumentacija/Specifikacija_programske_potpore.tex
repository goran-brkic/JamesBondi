\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\noindent \label{UC12} \underbar{\textbf{UC12 - Odgovor na zahtjev za terminom konzultacija}}
			\begin{packed_item}
				...
				\item[] \begin{packed_enum}
					...
					\item Polaznik dobiva obavijest o terminu i potvrđuje ga
				...
				\item[] \begin{packed_enum}
					...
					\item Polaznik potvrđuje termin ili ga odbija i šalje zahtjev za novim terminom \hyperref[UC11]{(UC11)}
			...
			\end{packed_item}
					\noindent \underbar{\textbf{UC16 - Pretraživanje tečajeva}}
				\begin{packed_item}
